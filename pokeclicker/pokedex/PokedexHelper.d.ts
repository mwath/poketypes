...
declare class PokedexHelper {
    ...
    static hideShinyImages: KnockoutObservable<boolean>;
    ...
    static filteredList: KnockoutComputed<[{
        id: number;
        name: "Bulbasaur";
        catchRate: number;
    ...
    static getList(): typeof pokemonList;
    static getGenderRatioData(pokemon: any): {
        male: number;
        female: number;
    };
